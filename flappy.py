...
def main(ges, nets):
    ...
    for idx, genome in enumerate(ges):
...
def mainGame(players, nets, genes):
    fitness = 0
    ...
    while len(players) != 0:
        ...
        for idx, player in enumerate(players):
            ...
            if crashTest[0] or playery < 0:
                player["fitness"] -= 1
                genes[idx].fitness = player["fitness"]
        ...
        for idx, player in enumerate(players):
            if not player["dead"]:
                ...
                if player["playerRot"] <= playerRotThr:
